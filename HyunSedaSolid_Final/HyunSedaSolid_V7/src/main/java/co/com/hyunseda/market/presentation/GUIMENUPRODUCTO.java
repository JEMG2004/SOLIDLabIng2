...
public class GUIMENUPRODUCTO extends javax.swing.JFrame {
    ...
    public GUIMENUPRODUCTO( ProductService productService) {
        initComponents();
        this.productService = productService;
    }

    private GUIMENUPRODUCTO() {
    ...
    private void btnAgregarProducActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarProducActionPerformed
        GUIAGREGARPRODUCT abrir = new GUIAGREGARPRODUCT(productService);
    ...
    private void btnEditarProducActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarProducActionPerformed
         GUIEDITARPRODUCT abrir = new GUIEDITARPRODUCT(productService);
        abrir.setVisible(true);
        this.setVisible(false); 
    ...
    private void btnEliminarProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarProductActionPerformed
        GUIELIMINARPRODUCT abrir = new GUIELIMINARPRODUCT(productService);
        abrir.setVisible(true);
        this.setVisible(false); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIMENUPRODUCTO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUIMENUPRODUCTO().setVisible(true);
            }
        });
    }
