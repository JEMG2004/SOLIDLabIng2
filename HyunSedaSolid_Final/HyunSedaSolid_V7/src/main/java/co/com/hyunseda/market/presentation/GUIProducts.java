...
public class GUIProducts extends javax.swing.JFrame {
    ...
    private void txtIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtIdFocusLost
        ...
        if (prod == null) {
            ...
            txtName.setText(prod.getProductName());
            txtDescription.setText(prod.getProductDescripcion());
        }
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindActionPerformed
        //GUIBUSCPRODUCTO instance = new GUIBUSCPRODUCTO(this, true, productService);
    ...
    private void editProduct() {
        ...
        prod.setProductName(txtName.getText().trim());
        prod.setProductDescripcion(txtDescription.getText().trim());
